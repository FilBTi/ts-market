...
class UserController {
    constructor() {
        ...
        this.updatePas = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield this.userservis.updatePassword(Number(req.params.id), req.body);
                if (user === null) {
                    res.status(404).send(`Not found user`);
                    return;
                }
        ...
        this.updateEmail = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield this.userservis.updateEmail(Number(req.params.id), req.body);
                if (user === null) {
                    res.status(404).send(`Not found user`);
                    return;
                }
